...
\begin{itemize}
    ...
    \item \textbf{Tactical and Performance Biases:} The spatial probability tensor is trained on elite-level professional matchplay (FA WSL). Tactical behaviors (e.g., double-pivot build-ups or terminal off-the-ball striker roles) reflect high-level professional dynamics and may not directly generalize to lower-tier or amateur networks.
\end{itemize}
