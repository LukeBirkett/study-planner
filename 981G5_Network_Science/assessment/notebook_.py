...
# %%
all_passes_df[all_passes_df['recipient_position'].isna()]
...
def plot_position_reception_diagnostics(
    ...
    # (pos_passes['pass_recipient'] == 'Emily Ann Fox')
    # ]

    # scaled locations
    x = pos_passes['pass_end_location'].apply(lambda loc: scale_coord(loc[0], axis='x')).tolist()
    y = pos_passes['pass_end_location'].apply(lambda loc: scale_coord(loc[1], axis='y')).tolist()
