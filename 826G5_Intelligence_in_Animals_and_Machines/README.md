[Module Page](https://canvas.sussex.ac.uk/courses/34991) /
...
[Root Lab Folder](weeks/labs)

#### Lab 1: Simulating Braitenberg's vehicles
* [Lab 1 Folder](weeks/labs/IAM_Sussex_labs/lab1)
* [My Lab](weeks/labs/IAM_Sussex_labs/lab1/lab1.py)
* [Completed Lab](weeks/labs/IAM_Sussex_labs/lab1/lab1_solved.py)

#### Lab 2: Elementary Motion Detection
* [Lab 2 Folder](weeks/labs/IAM_Sussex_labs/lab2)
* [Comprehensive Lab Notes](weeks/labs/IAM_Sussex_labs/lab2/lab_notes.md)

#### Lab 3 & 4: Assessment Prep
* Lab 3 covered Monte Carlo simulation of collective behaviour
* Lab 4 provides guided tasks which can lead to the basis of the assessment
* [Combined Lab Notes](weeks/labs/IAM_Sussex_labs/lab_3_robinson/notes/lab_notes.md)
* [Lab 3 Folder](weeks/labs/IAM_Sussex_labs/lab_3_robinson)
* [Paper: Simple Threshold Rule](weeks/labs/IAM_Sussex_labs/lab_3_robinson/papers/a_simple_threshold_rule.pdf)
