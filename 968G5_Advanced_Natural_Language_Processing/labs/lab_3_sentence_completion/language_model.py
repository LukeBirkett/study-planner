...
class language_model():
    ...
    def __init__(self,trainingdir=TRAINING_DIR,files=[]):
        ...
        self.files=files
        self.adjust_unknowns=True
        #this will adjust the probability of _UNK so that it is the probability of an individual unknown word rather than any unknown word
    ...
    ###adjust __UNK probabilities to include probability of an individual unknown word (1/number_unknowns)
        print("Adjusting _UNK probabilities so that it returns probability of individual unknown word rather than ANY unknown word")
