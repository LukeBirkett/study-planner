...
\begin{table}[htbp]
  \centering
  \caption{Bag-of-Words Input Dimensions}
...
\begin{table}[htbp]
  \centering
  \caption{Word2Vec Input Dimensions}
...
\begin{table}[htbp]
  \centering
  \caption{Task 1 MLP Head Hyperparameter Search}
...
\begin{table}[htbp]
  \centering
  \caption{Per-Class Evaluation Formulations}
...
% ====================================
\subsection{Architecture Variation 1: The Decoupled Model}
...
\begin{table}[htbp]
  \centering
  \caption{Length-Adaptive Boundary Tolerance ($\delta$) Rules}
...
\begin{table}[htbp]
  \centering
  \caption{Task 2 Evaluation Results}
...
\begin{table}[htbp]
  \centering
  \caption{Propaganda Technique Definitions \cite{dasan2020}}
...
\begin{table}[htbp]
  \centering
  \caption{Universal Pre-Processing Pipeline}
