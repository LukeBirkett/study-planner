...
First comparison: tagged vs untagged. Tagged we use the human senses, where as untagged we use the split strategy counts. The results show that the untagged performed better on average. It is on average because there are 3 measures and 3 datasets therefore the results vary. 
